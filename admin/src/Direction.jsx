...
//       await axios.post('https://medbed1.onrender.com/api/v1/direction/store-end-location', {
...
//     try {
//       const response = await axios.post('https://medbed1.onrender.com/api/v1/location/check', {
...
//       try {
//         const response = await axios.get('https://medbed1.onrender.com/api/v1/hospitals/getAllHospitals');
...
const Direction = () => {
  ...
  const checkLocationForHospital = async (hospitalId) => {
    try {
      const response = await axios.get(`https://medbed1.onrender.com/api/v1/location/check-location/${hospitalId}`);
